...
function pp_post_hello_world(){
	...
	$post = array(
		...
		'post_content' => "This is an example of an auction item. You could add an enticing description or alluring picture here.",
		'post_status' => 'publish',
		'post_title' => 'Hello Bidders',
		'post_type' => 'auctions'
	);
...
function pp_register_completed_status() {
	register_post_status(
	       'completed',
	       array('label' => _x( 'Completed', 'post', 'prospress' ),
				'label_count' => _n_noop( 'Completed <span class="count">(%s)</span>', 'Completed <span class="count">(%s)</span>', 'prospress' ),
				'public' => true,
...
add_action( 'pp_uninstall', 'pp_posts_deactivate' );
